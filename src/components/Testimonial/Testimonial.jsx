...
const TestimonialData = [
    {
        id:1,
        name:"Victor",
        text:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Perspiciatis fugit dolores beatae eveniet aliquid repudiandae doloremque assumenda commodi autem",
  ...
  return (
    <div className="py-10 mb-10">
        <div className="container">
            {/*Header Section */}
            <div className="max-w-[600]px mx-auto text-center mb-10">
                <p data-aos="fade-up" className="text-sm text-primary">What our customers are saying</p>
                <h1 data-aos="fade-up" className="text-3xl font-bold">Testimonials</h1>
                <p data-aos="fade-up" className="text-xs text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, provident exercitationem?</p>
            </div>
            {/*Testimonial Cards */}
